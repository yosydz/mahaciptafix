<!-- ======= Hero Section ======= -->
@php
    $end = date('m/d/Y', strtotime(@$produk[0]->tanggal_end));
    $start = date('m/d/Y', strtotime(@$produk[0]->tanggal));
...
@endif
             <form action="{{ asset('proses_pemesanan') }}" method="post" accept-charset="utf-8">
              ...
              <div class="col-md-8">
                ...
                <select name="id_produk" disabled class="form-control select2">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" name="tanggal_order" class="form-control daterange" placeholder="Tanggal Order" value="">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" name="nama_pemesan" class="form-control" placeholder="Nama Anda" value="{{ session()->get('nama') }}" required>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="email" name="email_pemesan" class="form-control" value="{{ session()->get('email') }}"  placeholder="Email Anda" required>
              </div>
            </div>
            ...
            <div class="col-md-4">
                <img src="{{ asset('public/upload/image/'.$gambar)}}" class="img img-thumbnail img-fluid">
            </div>
