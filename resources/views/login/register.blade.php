              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 font-weight-bold text-gray-900 mb-4">REGISTRASI</h1>
                    <hr>
                    <p>{{ $site->tagline }}</p>
                    <hr>
                  </div>
                  <form action="{{ asset('login/proses_register') }}" method="post" accept-charset="utf-8">
                  {{ csrf_field() }}
                  ...
                  <div class="text-center">
                    <a class="small" href="{{ asset('login') }}">Sudah punya akun login?</a> | <a class="small" href="{{ asset('/') }}">Kembali ke Beranda</a>
                  </div>
                </div>
              </div>
            </div>
