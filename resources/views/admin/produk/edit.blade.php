...
<form action="{{ asset('admin/produk/edit_proses') }}" method="post" enctype="multipart/form-data"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <select name="id_kategori_produk" class="form-control">
                ...
                <option value="<?php echo $kategori_produk->id_kategori_produk; ?>" <?php if ($kategori_produk->id_kategori_produk == $produk->id_kategori_produk) {
                    echo 'selected';
    ...
    <div class="form-group row">
        <label class="col-sm-3 control-label text-right">Masa Berlaku <span class="text-danger">*</span></label>
        <div class="col-sm-3">
            <input type="text" name="tgl_mulai" required class="tanggal form-control" placeholder="Tanggal Mulai"
                value="{{ $produk->tanggal }}">
            <small class="text-gray">Tanggal Mulai</small>
        </div>
        <div class="col-sm-3">
            <input type="text" name="tgl_akhir" required class="tanggal form-control" placeholder="Tanggal Berakhir"
                value="{{ $produk->tanggal_end }}">
            <small class="text-gray">Tanggal Berakhir</small>
        </div>
    </div>
    ...
    <!-- <div class="form-group row">
        <label class="col-sm-3 control-label text-right">Deskripsi Ringkas &amp; Keywords Produk (untuk pencarian
            Google)</label>
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
            ...
            <small class="text-gray">Gunakan koma sebagai pemisah, misal: <strong>web design, desain grafis, produk web,
                    produk android</strong></small>
        </div>
    </div> -->

    <div class="form-group row">
        <label class="col-sm-3 control-label text-right">Thumbnail gambar</label>
        <div class="col-sm-9">
  ...
  <small class="text-gray">Harga beli</small>
    ...
    <!--- <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="number" name="harga_terendah" class="form-control" placeholder="Harga eceran terendah"
                value="{{ $produk->harga_terendah }}">
            <small class="text-gray">Harga eceran terendah</small>
        </div>
        <div class="col-sm-3">
            <input type="number" name="harga_tertinggi" class="form-control" placeholder="Harga eceran tertingi"
    ...
    <!-- <div class="form-group row">
        ...
        <div class="col-sm-3">
            <select name="jenis_diskon" class="form-control">
                ...
                <option value="Persentase" <?php if ($produk->jenis_diskon == 'Persentase') {
                    echo 'selected';
                } ?>>Persentase (%)</option>
            </select>
        ...
        <div class="col-sm-3">
            <input type="number" name="besar_diskon" class="form-control" placeholder="Besar Diskon"
                value="{{ $produk->besar_diskon }}">
    ...
    <!-- <div class="form-group row">
        <label class="col-sm-3 control-label text-right">Periode Diskon (<small class="text-danger">Jika
                ada</small>)</label>
        <div class="col-sm-3">
            <input type="text" name="mulai_diskon" class="form-control tanggal" placeholder="dd-mm-yyyy"
                value="{{ $produk->mulai_diskon }}">
            <small class="text-gray">Format: dd-mm-yyyy</small>
        </div>
        <div class="col-sm-3">
            <input type="text" name="selesai_diskon" class="form-control tanggal" placeholder="dd-mm-yyyy"
                value="{{ $produk->selesai_diskon }}">
            <small class="text-gray">Format: dd-mm-yyyy</small>
        </div>
    </div>-->

    <div class="form-group row">
        <label class="col-sm-3 control-label text-right">Jumlah minimal &amp; Maksimal order (<small
                class="text-danger">Minimal dan maksimal</small>)</label>
        <div class="col-sm-3">
            <input type="number" name="jumlah_order_min" class="form-control" placeholder="Jumlah minimal"
                value="{{ $produk->jumlah_order_min }}">
            <small class="text-gray">Jumlah <strong>minimal</strong> order dalam 1 kelas</small>
        </div>
        <div class="col-sm-3">
            <input type="number" name="jumlah_order_max" class="form-control" placeholder="Jumlah maksimal"
                value="{{ $produk->jumlah_order_max }}">
    ...
    <!-- <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="text" name="satuan" class="form-control" placeholder="Satuan"
                value="{{ $produk->satuan }}">
            <small class="text-gray">Misal: Kamar, Bungkus. Pak, Kilogram, Gram</small>
        </div>
        <div class="col-sm-2">
