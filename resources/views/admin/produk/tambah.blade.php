...
<form action="{{ asset('admin/produk/tambah_proses') }}" method="post" enctype="multipart/form-data"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="date" name="tgl_mulai" required class="form-control" placeholder="Tanggal Mulai"
                value="{{ old('tgl_mulai') }}">
            <small class="text-gray">Tanggal Mulai</small>
        </div>
        <div class="col-sm-3">
            <input type="date" name="tgl_akhir" required class="form-control" placeholder="Tanggal Berakhir"
                value="{{ old('tgl_akhir') }}">
