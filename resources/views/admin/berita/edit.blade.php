...
{{ csrf_field() }}
<input type="hidden" name="id_berita" value="{{ $berita->id_blog }}">
<div class="row form-group">
  <label class="col-md-3">Judul berita/profil/layanan</label>
  <div class="col-md-6">
    <input type="text" name="judul_berita" class="form-control" placeholder="Judul berita/profil/layanan" required="required" value="<?php echo $berita->judul_blog ?>">
  </div>
</div>
...
<select name="status_berita" class="form-control select2">
  ...
  <option value="Draft" <?php if($berita->status_blog=="Draft") { echo "selected"; } ?>>Simpan sebagai draft</option>
</select>
</div>
<div class="col-md-2">
...
<select name="jenis_berita" class="form-control select2">
	...
	<option value="Profil"  <?php if($berita->jenis_blog=="Profil") { echo "selected"; } ?>>Profil</option>
  <option value="Layanan"  <?php if($berita->jenis_blog=="Layanan") { echo "selected"; } ?>>Layanan</option>
  <option value="Keunggulan"  <?php if($berita->jenis_blog=="Keunggulan") { echo "selected"; } ?>>Keunggulan</option>
</select>
</div>
