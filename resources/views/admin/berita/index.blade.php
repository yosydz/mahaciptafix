...
<tr class="odd gradeX">
    <td class="text-center">
      <div class="icheck-primary">
        <input type="checkbox" class="icheckbox_flat-blue " name="id_berita[]" value="<?php echo $berita->id_blog ?>">
    ...
    <td>
    <a href="{{ asset('blog/read/'.$berita->slug_blog) }}" target="_blank">
    <?php echo $berita->judul_blog ?> <sup><i class="fa fa-pencil"></i></sup>
    </a>
      <small>
        ...
        <?php if($berita->jenis_blog=="Promo") { ?>
    ...
    <td>
    <a href="{{ asset('admin/berita/jenis_berita/'.$berita->jenis_blog) }}">
    <?php echo $berita->jenis_blog ?><sup><i class="fa fa-link"></i></sup>
    </a></td>
    <td><a href="{{ asset('admin/berita/status_berita/'.$berita->status_blog) }}">
      <span class="btn btn-sm <?php if($berita->status_blog=="Publish") { echo 'btn-success'; }else{ echo 'btn-warning'; } ?> btn-block">
        <i class="fa <?php if($berita->status_blog=="Publish") { echo 'fa-check-circle'; }else{ echo 'fa-times'; } ?>"></i> <?php echo $berita->status_blog ?></span>
    </a></td>
    <td>
    ...
    <td>
      <div class="btn-group">
        <a href="{{ asset('blog/read/'.$berita->slug_blog) }}"
        class="btn btn-success btn-sm" target="_blank"><i class="fa fa-eye"></i></a>
        <a href="{{ asset('admin/berita/edit/'.$berita->id_blog) }}"
        class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

        <a href="{{ asset('admin/berita/delete/'.$berita->id_blog) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i></a>
      </div>
    </td>
</tr>
