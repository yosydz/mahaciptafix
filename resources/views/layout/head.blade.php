...
<head>
    ...
    <link href="{{ asset('public/template/assets/vendor/owl.carousel/assets/owl.carousel.min.css') }}"
        rel="stylesheet">
    ...
    <!-- Owl Stylesheets -->
    <link rel="stylesheet"
        href="{{ asset('public/owlcarousel/docs/assets/owlcarousel/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('public/owlcarousel/docs/assets/owlcarousel/assets/owl.theme.default.min.css') }}">
    ...
    <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js"
        data-client-key="SB-Mid-client-w82b_lsqvRfckBa1"></script>
