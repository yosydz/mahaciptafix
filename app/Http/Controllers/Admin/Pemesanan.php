...
class Pemesanan extends Controller
{
    ...
    public function status_pemesanan($status_pemesanan)
    {
        ...
        $data = array(
            'title'     => 'Status Pemesanan: ' . $status_pemesanan,
            'pemesanan' => $pemesanan,
            'kategori'  => $kategori,
            'content'   => 'admin/pemesanan/index'
        );
    ...
    public function detail($id_pemesanan)
    {
        ...
        $data = array(
            'title'     => 'Order No. ' . $pemesanan->kode_transaksi . ' a.n: ' . $pemesanan->nama_pemesan,
            'pemesanan' => $pemesanan,
            'site'      => $site,
    ...
    public function cetak($id_pemesanan)
    {
        ...
        $data = array(
            'title'     => 'Order Nomor ' . $pemesanan->kode_transaksi . ' atas nama ' . $pemesanan->nama_pemesan,
            'pemesanan' => $pemesanan,
            'site'      => $site
        );
        $config = [
    ...
    public function filter($mulai, $selesai, $status_pemesanan)
    {
        ...
        $data = array(
            'title'       => 'Data Order dg Status: ' . $status_pemesanan . ' pada Periode: ' . date('d-m-Y', strtotime($mulai)) . ' s/d ' . date('d-m-Y', strtotime($selesai)),
            'pemesanan'   => $pemesanan,
            'content'     => 'admin/pemesanan/index'
        );
        return view('admin/layout/wrapper', $data);
    ...
    public function proses(Request $request)
    {
        ...
        if (isset($_POST['hapus'])) {
            ...
            if ($id_pemesanannya != null) {
                ...
                return redirect($pengalihan)->with(['warning' => 'Pilih data']);
            }
